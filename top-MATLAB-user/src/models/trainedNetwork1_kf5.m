function net=trainedNetwork1_kf5()
...
tempNet = [
    ...
    dropoutLayer(0.01,"Name","dropout")
...
tempNet = [
    ...
    convolution2dLayer([3 3],64,"Name","Encoder-Stage-3-Conv-1","Padding","same","WeightsInitializer","he")
...
tempNet = [
    ...
    convolution2dLayer([3 3],256,"Name","LatentNetwork-Bridge-Conv-1","Padding","same","WeightsInitializer","he")
    reluLayer("Name","LatentNetwork-Bridge-ReLU-1")
    convolution2dLayer([3 3],256,"Name","LatentNetwork-Bridge-Conv-2","Padding","same","WeightsInitializer","he")
...
tempNet = [
    ...
    transposedConv2dLayer([2 2],64,"Name","Decoder-Stage-2-UpConv","BiasLearnRateFactor",2,"Stride",[2 2],"WeightsInitializer","he")
...
tempNet = [
    ...
    transposedConv2dLayer([2 2],32,"Name","Decoder-Stage-3-UpConv","BiasLearnRateFactor",2,"Stride",[2 2],"WeightsInitializer","he")
...
tempNet = [
    ...
    transposedConv2dLayer([2 2],16,"Name","Decoder-Stage-4-UpConv","BiasLearnRateFactor",2,"Stride",[2 2],"WeightsInitializer","he")
