function net=trainedNetwork_unet9()
...
tempNet = [
    ...
    convolution2dLayer([3 3],256,"Name","Encoder-Stage-4-Conv-1","Padding","same","WeightsInitializer","he")
    reluLayer("Name","Encoder-Stage-4-ReLU-1")
    convolution2dLayer([3 3],256,"Name","Encoder-Stage-4-Conv-2","Padding","same","WeightsInitializer","he")
    reluLayer("Name","Encoder-Stage-4-ReLU-2")
    dropoutLayer(0.02,"Name","Encoder-Stage-4-DropOut")];
net = addLayers(net,tempNet);

tempNet = [
    maxPooling2dLayer([2 2],"Name","Encoder-Stage-4-MaxPool","Stride",[2 2])
    convolution2dLayer([3 3],512,"Name","LatentNetwork-Bridge-Conv-1","Padding","same","WeightsInitializer","he")
    reluLayer("Name","LatentNetwork-Bridge-ReLU-1")
    convolution2dLayer([3 3],512,"Name","LatentNetwork-Bridge-Conv-2","Padding","same","WeightsInitializer","he")
    reluLayer("Name","LatentNetwork-Bridge-ReLU-2")
    dropoutLayer(0.02,"Name","LatentNetwork-Bridge-DropOut")
...
tempNet = [
    ...
    convolution2dLayer([3 3],32,"Name","Decoder-Stage-4-Conv-1","Padding","same","WeightsInitializer","he")
    reluLayer("Name","Decoder-Stage-4-ReLU-1")
    convolution2dLayer([3 3],32,"Name","Decoder-Stage-4-Conv-2","Padding","same","WeightsInitializer","he")
