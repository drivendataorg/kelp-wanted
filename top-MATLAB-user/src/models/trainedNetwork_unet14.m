function net=trainedNetwork_unet14()
...
tempNet = [
    ...
    convolution2dLayer([3 3],1024,"Name","LatentNetwork-Bridge-Conv-1","Padding","same","WeightsInitializer","he")
    reluLayer("Name","LatentNetwork-Bridge-ReLU-1")
    convolution2dLayer([3 3],1024,"Name","LatentNetwork-Bridge-Conv-2","Padding","same","WeightsInitializer","he")
...
tempNet = [
    ...
    transposedConv2dLayer([2 2],128,"Name","Decoder-Stage-4-UpConv","BiasLearnRateFactor",2,"Stride",[2 2],"WeightsInitializer","he")
